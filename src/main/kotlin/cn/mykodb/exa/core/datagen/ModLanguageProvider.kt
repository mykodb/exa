...
object ModLanguageProvider {
    ...
    class EnUs(output: PackOutput) : LanguageProvider(output, MODID, "en_us") {
        override fun addTranslations() {
            ...
            addPotions(
                ...
                "Potions of Teleport",
                "Splash Potion of Teleport",
                "Lingering Potion of Teleport ",
                "Arrow of Teleport"
            )
            addPotions(
            ...
            addItem(ModBlocks.LAVA_SINK, "Lava Sink")
            add("itemGroup.exa","Exa")
        }
    }
    ...
    class ZhCn(output: PackOutput) : LanguageProvider(output, MODID, "zh_cn") {
        override fun addTranslations() {
            ...
            addItem(ModBlocks.LAVA_SINK, "熔岩槽")
            add("itemGroup.exa","Exa")
        }
    }

    fun LanguageProvider.addPotions(
        key: DeferredHolder<Potion, Potion>,
        baseName: String,
        splashName: String,
        lingeringName: String,
        arrowName: String
    ) {
